...
void main() {
  ...
  group('Complex expression', () {
    test('should serialize into JSON', () {
      ...
      var expected =
          '{"type":"or_tag_expression","first":{"type":"and_tag_expression","first":{"predicate":{"_expectedValue":"AUTHOR_ID","_targetedTag":{"id":"TAG_AUTHOR","name":"author","type":0,"isUserEditable":false},"_valueType":"string","description":"author is Bob","type":"exact_value_predicate"},"type":"single_tag_expression"},"second":{"predicate":{"type":"greater_than_value_predicate","_limitValue":100,"_targetedTag":{"id":"TAG_NUMBER_OF_PAGES","name":"number of pages","type":1,"isUserEditable":false},"description":"number of pages is greater than 100"},"type":"single_tag_expression"}},"second":{"predicate":{"type":"greater_than_value_predicate","_limitValue":200,"_targetedTag":{"id":"TAG_NUMBER_OF_PAGES","name":"number of pages","type":1,"isUserEditable":false},"description":"number of pages is greater than 200"},"type":"single_tag_expression"}}';
      expect(actual, equals(expected));
    });
